...
export const CARDS: Card[] = [
    ...
    new Card(
        ...
        0,
        "full_moon",
        "Do an activity during a full moon night. Don't miss it, it happens only once a month!",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "swimming_bird",
        "Take a clear photo of an any swimming bird during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "forest_bird",
        "Take a clear photo of an any forest bird in a forest during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "urban_bird",
        "Take a clear photo of an any urban bird in city environment during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "wetland_bird",
        "Take a clear photo of an any wetland bird in wetland (swamp, marsh, etc.) environment during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "field_bird",
        "Take a clear photo of an any field bird (swallow, wagtail, wheateater etc.) in an open rural field during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        0,
        "wading_bird",
        "Take a clear photo of an any wading bird (long legged birds, storks, herons, sandpipers, lapwings, etc.) next to water during your activity",
        Currencies.withPoints(1).withExperience(5),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
    ...
    new Card(
        ...
        Currencies.withPoints(1).withExperience(10),
        1,
        0,
        {progression: 0,usesToProgress: 0,},
        'null',
    ...
    new Card(
        ...
        0,
        "pedaling",
        "Ride anything pedal-powered (except regular bicycle), pedal boat, tandem, tricycle, etc.",
        Currencies.withPoints(1).withExperience(4),
        1,
        0,
        {progression: 0,usesToProgress: 0},
    ...
    new Card(
        ...
        Currencies.withPoints(1).withExperience(7),
        1,
        0,
        {progression: 0,usesToProgress: 0},
        'null',
    ...
    new Card(
        ...
        "machine_5",
        "Record a long distance activity",
        Currencies.withPoints(1).withExperience(8),
        1,
        0,
        {progression: 0,usesToProgress: 0},
        'null',
    ...
    new Card(
        ...
        "machine_9",
        "Record a long distance activity",
        Currencies.withPoints(1).withExperience(14),
        1,
        0,
        {progression: 0,usesToProgress: 0},
        'null',
    ...
    new Card(
        ...
        "machine_10",
        "Record a long distance activity",
        Currencies.withPoints(1).withExperience(16),
        1,
        0,
        {progression: 0,usesToProgress: 0},
        'null',
